...
async def greet(name: str) -> Dict:
    """
    This endpoint greets a user. It does that by accepting
    their name and greeting them accordingly.

    name [string]: The name of the person to be greeted
    return [Dictionary]: The greetings as a dictionary
    """
    if name is int:
        raise ValueError("Does not accept interger")
...
async def converter(params: ConverterInput) -> Dict:
    ...
    :return:  A dictionary output of the amount in your currenc
    """
    if params.rate < 0:
